...
-t was passed the value ~, in the tree below, stow knows to target .config/nvim to ~/.config/nvim, it does this because the file path is common/nvim/.config/nvim,
